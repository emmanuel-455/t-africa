    ...
    <div className="flex space-x-4 overflow-hidden">
      {products.map((product, index) => (
        <Link
          ...
          className="w-[150px] md:w-[200px] bg-white flex flex-col flex-shrink-0 px-2 rounded-md"
        >
          <img
          ...
          <div className="flex flex-col justify-between">
            ...
            <p className="text-green-500 font-medium mb-2 text-sm">Handpicked for You</p>
          </div>
        </Link>
      ))}
    </div>

...
function Footer() {
  return (
    <div className='flex md:flex-row mt-[80px] px-5 flex-col md:pb-[80px] pb-[50px] lg:pb-[79px] justify-between items-start'>
      <div className='flex flex-col gap-6 md:mb-0 mb-[30px]'>
        <div className=''>
